...
В /home/hduser/ лежит java и class файл из примера выше. Так же эти файлы уже посчитаны лежат в дирректории Хадупа. В довнлоасе есть рузультат.
Что бы забросить файл в Hadoop
hadoop hdfs -put local remove
Что бы достать можно воспользоваться браузером (в ФФ, закрепленная вкладка на localhost, после старта Хадупа).
Или же
